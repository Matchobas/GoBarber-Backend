...
const routes = (0, _express.Router)(); // Para qualquer rota que usa o appointmentsRouter ele passa '/appointments' como
// uma base, o mesmo acontece para todas as outras rotas
